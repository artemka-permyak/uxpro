...
CREATE TABLE public.blocks (
    ...
    CONSTRAINT blocks_images_mosaic_check CHECK (((images_mosaic)::text = ANY ((ARRAY['left'::character varying, 'top'::character varying])::text[])))
);
