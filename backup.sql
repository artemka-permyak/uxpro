...
1	Цифровой профиль	{"Цифровой профиль снимает нагрузку с родителей школьников. Больше не нужно проверять тетради и дневники, высчитывать вероятные оценки за четверть — достаточно просто зайти в профиль","В нём собрана вся информация — успеваемость, посещаемость, статистика, достижения, события"}	2024	{Исследования,Проектирование,"Дизайн интерфейса",Дизайн-контроль}	https://uxpro.ru/images/digital-profile/app-image.png	Цифровой профиль ученика и педагога средней школы	{Web,Mobile,Desktop,Образование,Платформа,Ученик,Учитель,Школа}	2024-12-12 21:25:32.21398	2025-07-14 16:39:28.848668	[{"src": "https://uxpro.ru/images/digital-profile/app-image.png", "type": "image"}]	[{"src": "https://uxpro.ru/images/wda-award.png", "title": "Призёр WDA", "description": "2 место"}, {"src": "https://uxpro.ru/images/dprofile-award.png", "title": "Рекомендуемое на dprofile.ru"}]
\.
