...
12	2	splitBlock	Поставщики	\N	\N	\N	2025-01-13 16:25:24.007324	2025-01-13 16:27:04.214658	{"Сервис спроектирован так, чтобы поставщик смог быстро оценить и проконтролировать сбыт. Всё движение товара в магазинах — перед глазами","Сразу видят ключевые метрики: активированные коды, статистику и динамику сбыта"}	3	\N	\N	\N	\N	[{"src": "http://uxpro.ru/images/profibonus/suppliers-1.png", "type": "image"}]	\N	one-to-two
