<template>
  <Container>
    <SplitBlock>
      ...
      <template #right>
        <div class="flex flex-col gap-size-12 max-xl:gap-size-8">
          <div class="flex flex-col gap-size-6">
            ...
            <div class="flex flex-col gap-size-6 text-grey max-w-[98.8rem] max-xl:w-full">
              <p
          ...
          <ContactUsFeature
            class="w-max text-h3 max-xl:hidden"
            icon-size="2xl"
            as-button
          />

          <ContactUsFeature
            class="w-max text-h2 xl:hidden"
            icon-size="lg"
            as-button
          />
        </div>
